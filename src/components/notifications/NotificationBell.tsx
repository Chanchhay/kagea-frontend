  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        ...
        {count > 0 ? (
          <span className="ws-notification-count absolute -right-0.5 -top-0.5 flex h-4.5 min-w-4.5 items-center justify-center rounded-full bg-primary px-1 text-xs font-bold text-primary-foreground">
            {count > 99 ? "99+" : count}
          </span>
        ) : null}
      </button>
