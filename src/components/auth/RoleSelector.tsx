        ...
        {roles.map((role) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative flex items-center gap-3 rounded-xl border p-3 text-left outline-none transition-colors focus-visible:ring-[3px] focus-visible:ring-brand/30",
                selected
            ...
            >
              ...
              {selected && (
                <CheckCircle2
                  aria-hidden="true"
                  className="absolute right-2.5 top-2.5 size-3.5 text-brand dark:text-[#7bf0a4]"
                />
              )}
            </button>
          );
