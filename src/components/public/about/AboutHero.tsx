      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="lg:col-span-7">
            ...
            >
              <div className="flex items-center gap-2 rounded-xl border border-slate-200/80 bg-white/70 px-3.5 py-2 backdrop-blur-sm dark:border-slate-800/80 dark:bg-slate-900/70">
            ...
            >
              ...
              <button className="rounded-xl border border-slate-200 bg-white/80 px-6 py-3.5 font-semibold text-slate-800 backdrop-blur-sm transition-all hover:bg-slate-100 dark:border-slate-800 dark:bg-slate-900/80 dark:text-white dark:hover:bg-slate-800">
                Learn More
              </button>
            </motion.div>
          </div>
          ...
          <div className="relative flex justify-center lg:col-span-5">
            ...
            >
              {/* Outer Pulsing Ring */}
              <div className="absolute inset-0 animate-ping rounded-full border border-[#F3BE00]/20 duration-3000" />
              <div className="absolute -inset-4 rounded-full border border-[#1fa628]/20" />
              ...
              <motion.div
                ...
                className="absolute -left-4 top-1/4 flex items-center gap-3 rounded-2xl border border-slate-200/90 bg-white/90 p-3.5 shadow-xl backdrop-blur-md dark:border-slate-800/90 dark:bg-slate-900/90 dark:shadow-[0_10px_30px_rgba(0,0,0,0.5)] sm:-left-8"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1fa628]/15 text-[#1fa628]">
              ...
              <motion.div
                ...
                className="absolute -right-4 bottom-10 flex items-center gap-3 rounded-2xl border border-slate-200/90 bg-white/90 p-3.5 shadow-xl backdrop-blur-md dark:border-slate-800/90 dark:bg-slate-900/90 dark:shadow-[0_10px_30px_rgba(0,0,0,0.5)] sm:-right-6"
              >
