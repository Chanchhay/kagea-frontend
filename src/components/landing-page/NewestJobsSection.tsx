        ...
        <div data-stagger className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {jobs.slice(0, 6).map((job, index) => {
            ...
            return (
              ...
              <article
                className="group relative flex h-full min-h-[205px] w-full transform-gpu flex-col justify-between overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-4 shadow-[0_4px_20px_-4px_rgba(15,23,42,.08)] transition-[transform,border-color,box-shadow] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-[1.005] hover:border-[#1FA628]/60 hover:shadow-[0_18px_38px_-16px_rgba(31,166,40,0.16),0_8px_18px_-10px_rgba(15,23,42,0.06)] dark:border-[#3E444B] dark:bg-[#22262C] dark:shadow-[0_14px_32px_-18px_rgba(0,0,0,.9)] dark:hover:border-[#1FA628]/50 dark:hover:shadow-[0_18px_38px_-16px_rgba(0,0,0,0.75),0_0_20px_rgba(31,166,40,0.16)]"
              >
                <div className="pointer-events-none absolute inset-0 rounded-2xl bg-linear-to-b from-[#1FA628]/[0.05] via-transparent to-transparent opacity-0 transition-opacity duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:opacity-100 dark:from-[#1FA628]/[0.10]" />
                <div>
